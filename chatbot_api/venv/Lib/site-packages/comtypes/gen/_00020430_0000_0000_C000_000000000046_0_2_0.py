...
IFontDisp = Font
__all__ = [ 'OLE_TRISTATE', 'OLE_XPOS_HIMETRIC', 'OLE_YPOS_PIXELS',
           'OLE_XSIZE_CONTAINER', 'Default', 'OLE_COLOR',
           'OLE_YSIZE_HIMETRIC', 'IPicture', 'OLE_ENABLEDEFAULTBOOL',
           'OLE_HANDLE', 'StdFont', 'StdPicture', 'IFontEventsDisp',
           'FONTSTRIKETHROUGH', 'OLE_YSIZE_CONTAINER', 'Color',
           'LoadPictureConstants', 'Picture', 'OLE_YPOS_CONTAINER',
           'OLE_XSIZE_HIMETRIC', 'FONTBOLD', 'Gray',
           'OLE_XPOS_CONTAINER', 'FONTNAME', 'Font',
           'OLE_XSIZE_PIXELS', 'IFontDisp', 'FontEvents', 'Checked',
           'Monochrome', 'FONTSIZE', 'VgaColor', 'OLE_CANCELBOOL',
           'OLE_YSIZE_PIXELS', 'OLE_XPOS_PIXELS', 'FONTUNDERSCORE',
           'IFont', 'FONTITALIC', 'OLE_YPOS_HIMETRIC',
           'OLE_OPTEXCLUSIVE', 'Unchecked', 'IPictureDisp']
